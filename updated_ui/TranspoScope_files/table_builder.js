...
function buildTable(table, area, patient) {
    "use strict";
    var i = "",
        j = "",
        oldTable = "",
...
//        td = document.createElement('td');
        ...
        a.href = "http://genome.ucsc.edu/cgi-bin/hgTracks?db=hg19&hubUrl=http://openslice.fenyolab.org/tracks/transposcope_track/" + area + "/" + patient  +  "/hub.txt&position="+chr+":"+(parseInt(pos,10)-1000)+"-"+(parseInt(pos,10)+1000);
        a.target = "_blank";
        td.appendChild(a);
        tr.appendChild(td);
        tr.onclick = (function () {
    ...
    $(function(){
        ...
        if (!this.asc){rows = rows.reverse();
            $("#header"+$(this).index()).text($("#header"+$(this).index()).text().substr(0,$("#header1").text().length-1)+"▽");}
        this.asc = !this.asc
